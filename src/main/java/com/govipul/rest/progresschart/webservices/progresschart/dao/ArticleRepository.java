...
/*
 * TODO: Change the type name to article table name from customs
 * 
 */
public interface ArticleRepository extends JpaRepository<RbkPdmCustoms, Integer> {

	@Query("SELECT c FROM RbkPdmCustoms c WHERE c.seasonCode=?1 " + "and dqCheck=1 and errorMessage LIKE '%SUCCESS%'")
